...
[@sacss/react-native](https://github.com/s-acss/sacss) It's same like SACSS naming rules, only replaced by a more flexible `key={value}` form, click me [see more](https://github.com/s-acss/sacss).
